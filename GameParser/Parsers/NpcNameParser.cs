...
{
    public static readonly Dictionary<int, string> NpcNames = new();
    public static readonly Dictionary<int, string> NpcNamesPlural = new();
    public static readonly Dictionary<int, string> NpcTitles = new();
