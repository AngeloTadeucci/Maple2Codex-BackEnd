...
public static class ItemParser
{
    ...
    public static void Parse()
    {
        ...
        foreach ((int id, string? name, ItemData? data) in parser.Parse())
        {
            ...
            (string tooltip, string guide, string main) description = descriptions.GetValueOrDefault(id);

            List<int> jobLimit = limit.jobLimit.Length == 0
                ? new()
                {
                    0
                }
            ...
            List<int> recommendJobs = limit.recommendJobs.Length == 0
                ? new()
                {
                    0
                }
                : limit.recommendJobs.ToList();
            ...
            List<(string itemNames, int id)> setData = new();
            ...
            QueryManager.QueryFactory.Query("items").Insert(new
            {
                ...
                tooltip_description = description.tooltip,
                guide_description = description.guide ,
                main_description = description.main ,
                rarity,
    ...
    {
        Dictionary<int, (string tooltip, string guide, string main)> descriptions = new();
        XmlDocument? xmlFile =
